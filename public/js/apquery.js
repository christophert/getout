		...
		$.ajax({
			...
			success: function(r) {
				...
				$("#tag_holder div:nth-of-type(9)").ready(function() {
					$("p#flightId1").html(inboundtrip[0][0].flightID);
					$("p#airline1").html(inboundtrip[0][0].airline);
					$("p#fltno1").html(inboundtrip[0][0].fltno);
					$("p#depart1").html(inboundtrip[0][0].depart);
					$("p#arrival1").html(inboundtrip[1][0].arrival);
				});
